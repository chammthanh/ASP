...
namespace Cake_Store.Areas.Admin.Controllers
{
    ...
    public class Product_DetailController : Controller
    {
        ...
        // GET: Admin/Product_Detail/Details/5
        ...
        // GET: Admin/Product_Detail/Create
        public IActionResult Create()
        {
            ViewData["ImagesId"] = new SelectList(_context.Image, "Id", "Id");
            ViewData["ProductId"] = new SelectList(_context.Product, "Id", "Id");
            ViewData["SizeId"] = new SelectList(_context.Product_Size, "Id", "Id");
            return View();
        }

        // POST: Admin/Product_Detail/Create
        ...
        public async Task<IActionResult> Create([Bind("Id,SizeId,ProductId,Date_Create,Quantity,Product_Price,Make_Date,Date_Expired,ImagesId")] Product_Detail product_Detail)
        {
            ...
            ViewData["SizeId"] = new SelectList(_context.Product_Size, "Id", "Id", product_Detail.SizeId);
            return View(product_Detail);
        }

        // GET: Admin/Product_Detail/Edit/5
        ...
        // GET: Admin/Product_Detail/Delete/5
        ...
        // POST: Admin/Product_Detail/Delete/5
