...
namespace Cake_Store.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        {
            ViewData["ProductTypeId"] = new SelectList(_context.Product_Type, "Id", "Type");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,ProductName,Descriptions,ProductTypeId,Discount")] Product product)
        {
            ...
            ViewData["ProductTypeId"] = new SelectList(_context.Product_Type, "Id", "Type", product.ProductTypeId);
            return View(product);
        }
