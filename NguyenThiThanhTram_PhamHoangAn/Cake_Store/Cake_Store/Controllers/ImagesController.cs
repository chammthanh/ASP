...
namespace Cake_Store.Controllers
{
    public class ImagesController : Controller
    {
        ...
        public ImagesController(Cake_StoreContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index(string input)
        {
            ...
            {
                return View(_context.Image.Where(ima => ima.Images.Contains(input) || ima.Id.ToString() == input));
            }    
        ...
        public async Task<IActionResult> Create([Bind("Id,Images")] Image image)
        {
